...
class ScoreLv4Page extends StatefulWidget {
  const ScoreLv4Page({super.key, required this.title});
  final String title;

  @override
  State<ScoreLv4Page> createState() => _ScoreLv4PageState();
}


class _ScoreLv4PageState extends State<ScoreLv4Page> {
    ...
    return  Scaffold(
        ...
        body: Stack(
          ...
          Container(
            ...
            Center(
              child: Text('${questionControl.numberOfCorrectAnswer4}',
              style: TextStyle(
                color: Colors.purple,
                fontFamily: 'Amatic',
                fontSize: 30
