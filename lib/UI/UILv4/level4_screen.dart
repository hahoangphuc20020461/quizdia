...
import 'package:quizdia/UI/UILv4/scorelv4_screen.dart';
...
class Level4Page extends StatefulWidget {
  const Level4Page({super.key, required this.title});
  final String title;
        ...
        body: Stack(children: <Widget>[
          ...
          Container(
            ...
            child: CircularCountDownTimer(
              ...
              onComplete: () {
                //_controller.restart();
                Navigator.push(context, MaterialPageRoute(builder: (context) => ScoreLv4Page(title: '')));
            ...
            children: [
                  ...
                  child: Obx(
                    () => Text.rich(
                      TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text: '/${questionControl.questions4.length}',
                            style: Theme.of(context)
                                .textTheme
                                .headlineSmall
              ...
              Expanded(
                ...
                itemBuilder: (BuildContext context, int index) => content_screen(
                  dataLevel4: questionControl.questions4[index],
                ),
                itemCount: questionControl.questions4.length,
              )),
...
class content_screen extends StatelessWidget {
  const content_screen({Key? key, required this.dataLevel4}) : super(key: key);

  final DataLevel4 dataLevel4;
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          ...List.generate(
              dataLevel4.options!.length,
              (index) => optional(
                  text: dataLevel4.options![index],
                  ind: index,
                  press: () {
                    questionControl.checkAns4(index, dataLevel4);
                  })),
