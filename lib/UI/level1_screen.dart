...
class Level1Page extends StatefulWidget {
  const Level1Page({super.key, required this.title});
  final String title;
        ...
        body: Stack(children: <Widget>[
          ...
          Container(
            ...
            child: CircularCountDownTimer(
              ...
              onComplete: () {
                //_controller.restart();
                Navigator.push(context, MaterialPageRoute(builder: (context) => ScoreLv1Page(title: '')));
            ...
            children: [
                  ...
                  child: Obx(
                    () => Text.rich(
                      TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text: '/${questionControl.questions.length}',
                            style: Theme.of(context)
                                .textTheme
                                .headlineSmall
              ...
              Expanded(
                ...
                itemBuilder: (BuildContext context, int index) => content_screen(
                  dataLevel1: questionControl.questions[index],
                ),
                itemCount: questionControl.questions.length,
              )),
...
class content_screen extends StatelessWidget {
  const content_screen({Key? key, required this.dataLevel1}) : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          ...List.generate(
              dataLevel1.options!.length,
              (index) => optional(
                  text: dataLevel1.options![index],
                  ind: index,
                  press: () {
                    questionControl.checkAns(index, dataLevel1);
                  })),
