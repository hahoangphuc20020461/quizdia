...
class ScoreLv2Page extends StatefulWidget {
  const ScoreLv2Page({super.key, required this.title});
  final String title;

  @override
  State<ScoreLv2Page> createState() => _ScoreLv2PageState();
}


class _ScoreLv2PageState extends State<ScoreLv2Page> {
    ...
    return  Scaffold(
        ...
        body: Stack(
          ...
          Container(
            ...
            Center(
              child: Text('${questionControl.numberOfCorrectAnswer2}',
              style: TextStyle(
                color: Colors.purple,
                fontFamily: 'Amatic',
                fontSize: 30
