        ...
        body: Stack(children: <Widget>[
          ...
          Container(
            ...
            child: CircularCountDownTimer(
              ...
              onComplete: () {
                //_controller.restart();
                Navigator.push(context, MaterialPageRoute(builder: (context) => ScoreLv2Page(title: '')));
            ...
            children: [
                  ...
                  child: Obx(
                    () => Text.rich(
                      TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text: '/${questionControl.questions2.length}',
                            style: Theme.of(context)
                                .textTheme
                                .headlineSmall
              ...
              Expanded(
                ...
                itemBuilder: (BuildContext context, int index) => content_screen(
                  dataLevel2: questionControl.questions2[index],
                ),
                itemCount: questionControl.questions2.length,
              )),
...
class content_screen extends StatelessWidget {
  const content_screen({Key? key, required this.dataLevel2}) : super(key: key);

  final DataLevel2 dataLevel2;
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          ...List.generate(
              dataLevel2.options!.length,
              (index) => optional(
                  text: dataLevel2.options![index],
                  ind: index,
                  press: () {
                    questionControl.checkAns2(index, dataLevel2);
                  })),
