...
class ScoreLv1Page extends StatefulWidget {
  const ScoreLv1Page({super.key, required this.title});
  final String title;

  @override
  State<ScoreLv1Page> createState() => _ScoreLv1PageState();
}


class _ScoreLv1PageState extends State<ScoreLv1Page> {
    ...
    return  Scaffold(
        ...
        body: Stack(
          ...
          Container(
            ...
            Center(
              child: Text('${questionControl.numberOfCorrectAnswer}',
              style: TextStyle(
                color: Colors.purple,
                fontFamily: 'Amatic',
                fontSize: 30
